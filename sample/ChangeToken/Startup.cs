...
namespace ChangeTokenSample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.Add(ServiceDescriptor.Singleton<ITest, TestB>());
            //services.Add(ServiceDescriptor.Singleton<ITest, TestB>());
            var list = new List<ServiceDescriptor>
            {
                ServiceDescriptor.Singleton<ITest, TestA>(),
                ServiceDescriptor.Singleton<ITest, TestB>(),
            };
            services.TryAddEnumerable(list);
            #endregion
